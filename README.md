...
パソコンとArduino本体で学べる、小・中学生向けのプログラミング入門教材です。基礎編（全14回）を公開しています。ブレッドボードなどの外付け部品は使わず、シリアルモニタを中心に学び、後半ではオンボードLEDやシリアルプロッタも扱います。基礎編に必要なのはパソコン・USBケーブル・Arduino Nano（互換品でOK）です。
